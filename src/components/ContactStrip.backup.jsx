      ...
      <div className="max-w-[1800px] mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-12 border-t border-white/10 pt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button className="flex items-center gap-3 bg-white text-black px-8 py-5 font-sans font-black text-xs uppercase tracking-widest hover:bg-primary hover:text-white transition-all group">
