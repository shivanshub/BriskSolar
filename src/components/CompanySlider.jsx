...
const CompanySlider = () => {
  ...
  return (
    <div className="w-full py-10 bg-white overflow-hidden border-y border-black/5">
      <div className="max-w-[1800px] mx-auto px-6 lg:px-12 mb-6">
      ...
      <div className="relative flex overflow-x-hidden group">
        <div className="animate-scroll flex items-center gap-16 whitespace-nowrap px-8 py-6">
          {allLogos.map((logo, i) => (
        ...
        <div className="animate-scroll flex items-center gap-16 whitespace-nowrap px-8 py-6" aria-hidden="true">
          {allLogos.map((logo, i) => (
