    ...
    <section ref={containerRef} className="py-24 px-6 lg:px-12 bg-surface">
      <div className="max-w-[1800px] mx-auto">
        <div className="flex justify-between items-end mb-24">
          ...
          <div className="hidden lg:block text-right max-w-xs font-body text-xs text-text-muted uppercase tracking-widest leading-loose font-extrabold">
          ...
          {services.map((service, i) => (
            <div key={i} className="service-card group relative aspect-[4/5] bg-surface-muted overflow-hidden p-8 flex flex-col justify-end cursor-pointer rounded-sm border border-black/5">
              ...
              <div className="relative z-20 space-y-4 translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                <h3 className="text-4xl font-extrabold tracking-tighter leading-none text-white font-heading">
                  {service.title}
                </h3>
                <p className="font-body text-[11px] text-white/60 uppercase tracking-widest leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                  {service.desc}
                </p>
        ...
        <div className="mt-16 flex justify-center">
          ...
          >
            <div className="w-20 h-20 rounded-full border border-black/5 flex items-center justify-center group-hover:bg-primary group-hover:border-primary transition-all duration-500">
              <ArrowRight className="w-8 h-8 text-text-muted group-hover:text-white transition-colors" />
            </div>
            <span className="font-body font-extrabold text-xs uppercase tracking-[0.4em] text-text-muted group-hover:text-primary transition-colors">Explore All 13 Services</span>
          </Link>
        </div>
      </div>
    </section>
