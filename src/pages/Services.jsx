  ...
  <div className="group bg-surface-muted border border-black/5 p-10 flex flex-col justify-between hover:border-primary transition-all duration-500 rounded-sm">
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="text-2xl font-extrabold tracking-tighter uppercase text-text-primary leading-none font-heading">{service.name}</h3>
        <p className="font-body text-[11px] font-extrabold uppercase tracking-widest text-primary border-l-2 border-primary/20 pl-3">{service.bestFor}</p>
        <p className="font-body text-sm text-text-muted leading-relaxed">{service.summary}</p>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="py-24 px-6 lg:px-12 max-w-[1800px] mx-auto">
        <div className="mb-24 space-y-4">
          <span className="text-primary font-body font-extrabold text-xs uppercase tracking-[0.5em]">The Catalogue</span>
          <h2 className="text-3xl lg:text-5xl font-extrabold tracking-tighter uppercase text-text-primary leading-none font-heading">Available Mechanisms.</h2>
        </div>
        ...
        <div className="mt-48 mb-48 space-y-12">
           <div className="space-y-4">
              <span className="text-primary font-body font-extrabold text-xs uppercase tracking-[0.5em]">The Matrix</span>
              <h2 className="text-3xl lg:text-5xl font-extrabold tracking-tighter uppercase text-text-primary leading-none font-heading">Recommendation Guide.</h2>
           </div>
              ...
              <table className="w-full border-collapse">
                 <thead>
                    <tr className="bg-surface-muted text-left">
                       <th className="p-8 font-body font-extrabold text-xs uppercase tracking-widest text-text-muted border border-black/5">Client Category</th>
                       <th className="p-8 font-body font-extrabold text-xs uppercase tracking-widest text-text-muted border border-black/5">Best Solar Model</th>
                       <th className="p-8 font-body font-extrabold text-xs uppercase tracking-widest text-text-muted border border-black/5">Primary Benefit</th>
                    </tr>
                 </thead>
                 <tbody>
                    <tr>
                       <td className="p-8 font-body font-extrabold text-lg text-text-primary border border-black/5 font-heading">Home / Small Office</td>
                       <td className="p-8 font-body font-bold text-primary border border-black/5 text-base">Net Metering</td>
                       <td className="p-8 font-body text-sm text-text-muted border border-black/5 leading-relaxed">Grid acts as a free battery for your extra energy.</td>
                    </tr>
                    <tr className="bg-surface-muted/30">
                       <td className="p-8 font-body font-extrabold text-lg text-text-primary border border-black/5 font-heading">Large Industry (Textile/Steel)</td>
                       <td className="p-8 font-body font-bold text-primary border border-black/5 text-base">Captive or Group Captive</td>
                       <td className="p-8 font-body text-sm text-text-muted border border-black/5 leading-relaxed">Direct savings by bypassing high cross-subsidy taxes.</td>
                    </tr>
                    <tr>
                       <td className="p-8 font-body font-extrabold text-lg text-text-primary border border-black/5 font-heading">Areas with Power Cuts</td>
                       <td className="p-8 font-body font-bold text-primary border border-black/5 text-base">DGPV Sync</td>
                       <td className="p-8 font-body text-sm text-text-muted border border-black/5 leading-relaxed">Drastic reduction in diesel costs during grid failures.</td>
                    </tr>
                    <tr className="bg-surface-muted/30">
                       <td className="p-8 font-body font-extrabold text-lg text-text-primary border border-black/5 font-heading">Housing Society</td>
                       <td className="p-8 font-body font-bold text-primary border border-black/5 text-base">Virtual Net Metering</td>
                       <td className="p-8 font-body text-sm text-text-muted border border-black/5 leading-relaxed">Solves the problem of shared roof space for apartments.</td>
                    </tr>
                 </tbody>
              </table>
           </div>
